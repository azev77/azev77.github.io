...
= \left( \rho\_{xz}\times \frac{\sigma\_{z}}{\sigma\_{x}} \right)
\times 
\left( \rho\_{zy}\times \frac{\sigma\_{y}}{\sigma\_{z}} \right)
=
\rho\_{xz}\times \rho\_{zy} \times \frac{\sigma\_{y}}{\sigma\_{x}} 
$

[^bignote]: To derive the bias, slightly abuse notation by stacking a column of ones and $X_{i}$ into a matrix "X", and stack 
