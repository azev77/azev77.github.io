...
```julia
  ...
  #
  df = DataFrame(
      Y =        [ones(8);zeros(80-8);  ones(4);zeros(20-4);     #China-Young: 8/80 die. China-Old:  4/20 die.
                  ones(1);zeros(20-1);  ones(12);zeros(80-12);], #Italy-Young: 1/20 die. Italy-Old: 12/80 die.
      Intercept = ones(N), 
...
Estimate CFR: unconditional/conditional on country/conditional on country & age
------
