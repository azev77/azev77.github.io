...
<br>
China-Young: $\text{CFR}\left(X_i, Z_i \right) = P\left(Y_i =1 | X_i=0, Z_i=0 \right) = \beta_{0} = 10\%$
<br>
China-Old: $\text{CFR}\left(X_i, Z_i \right) = P\left(Y_i =1 | X_i=0, Z_i=0 \right) = \beta_{0} + \beta_{zy}= 10\% + 10\% = 20\%$
