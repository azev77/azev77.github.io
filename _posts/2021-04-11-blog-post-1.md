...
<br>
Under the true DGP, $\text{CFR} \equiv P\left(Y_i =1 | X_i, Z_i \right) =E\left[Y_i =1 | X_i, Z_i \right]$. 
<br>
China-Young: $\text{CFR} \equiv P\left(Y_i =1 | X_i=0, Z_i=0 \right) = \beta_{0} = 10\%$
