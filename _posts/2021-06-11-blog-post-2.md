...
<br>
1. Creates random variables: built-in variables/fit random variables/transform random variables 
2. Sample random variables
3. Compute properties: probabilities/moments/cumulants/entropies etc 
<br>
